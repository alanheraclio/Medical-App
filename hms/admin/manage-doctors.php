				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<span class="text-bold">Search Patient: </span>
...
?>
	...
	<tr>
		...
		<td><div class="visible-md visible-lg hiddehidden-xs">
				<a href="manage-appointments.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="glyphicon glyphicon-edit"></i></a>
			</div></td>
		<td >
			<div class="visible-md visible-lg hiddehidden-xs">
