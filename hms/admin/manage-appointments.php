...
<html lang="en">
	<head>
		<title>Admin | History Appointments</title>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" type="text/css" href="assets/css/search-button.css">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | History Appointments</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>History Appointments</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">History Appointments</h5>
												</div>
												<div class="panel-body">
									
				  <label for="comment">Appointments:</label> 
